...
# Code: https://www.youtube.com/watch?v=yDto2FnJipI - Mostly Mad Productions
...
func _button_pressed() -> void:
	...
	button_press_tween.tween_property(self, "scale", hover_scale, 0.06).set_trans(Tween.TRANS_SINE)
